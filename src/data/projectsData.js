const projectsData = [
  {
    ...
    caseStudy: {
      ...
      timeline: "School society platform",
      problem: "The Maths Society needed a more engaging home for challenges, updates, and student participation than static announcements could provide.",
      solution: "Built a Flask application with challenge flows, leaderboards, and newsletter-oriented content so students could return regularly and track progress.",
      highlights: [
      ...
      lessons: "This project sharpened my thinking around building useful internal tools for a real group of users, not just building a technically interesting demo."
    },
    links: {
  ...
  caseStudy: {
    ...
    timeline: "Distributed systems project",
    problem: "Managing multiple Minecraft servers manually becomes fragile when player load changes, servers fail, or operators need to coordinate commands across instances.",
    solution: "Implemented an orchestration layer that can observe server health, coordinate a Java-side plugin, and support operational commands from a web dashboard.",
    highlights: [
    ...
    lessons: "The project made distributed systems feel concrete: every clean abstraction still has to survive latency, state, failures, and operator expectations."
  },
  links: {
  ...
  },
  {
    ...
    caseStudy: {
      ...
      timeline: "CLI automation project",
      problem: "Manual stock checking is slow and unreliable when product availability changes quickly.",
      solution: "Created a Python CLI that combines direct HTTP checks with Playwright browser automation for cases where page behavior needs to be observed directly.",
      highlights: [
      ...
      lessons: "This was a useful exercise in balancing speed, reliability, and politeness when automating against real websites."
    },
    links: {
  ...
  },
  {
    ...
    caseStudy: {
      ...
      timeline: "Productivity app",
      problem: "Habit tracking and focused work sessions are often separated, even though they support the same goal: consistent progress.",
      solution: "Built a React application that combines habit streaks, Pomodoro-style focus sessions, and progress analytics in one minimal interface.",
      highlights: [
      ...
      lessons: "Rava pushed me to think about product restraint: productivity tools need to stay useful without becoming another source of friction."
    },
    links: {
  ...
  },
  {
    ...
    caseStudy: {
      ...
      timeline: "Mathematics visualization",
      problem: "Normal distributions are easier to understand when learners can manipulate parameters and see the curve respond immediately.",
      solution: "Converted an original Python idea into a JavaScript visualization with interactive parameter changes and real-time plotted output.",
      highlights: [
      ...
      lessons: "The strongest educational tools do not just explain a concept; they let someone test their intuition against it."
    },
    links: {
