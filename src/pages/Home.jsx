      ...
      {!loading && (
        ...
        >
          <div className="text-left max-w-lg">
            <h1 className="text-7xl md:text-8xl lg:text-8xl leading-tight title">YOUSUF</h1>
            <h1 className="text-7xl md:text-8xl lg:text-8xl leading-tight title">SHAHZAD</h1>
            ...
            <button className="group mt-6 px-6 py-3 bg-black text-white text-lg rounded hover:bg-gray-800 transition">
              Learn More <span className="ml-2 group-hover:ml-10 duration-700 ease-out">→</span>
            </button>
          </div>
