...
const About = () => {
    ...
    const paragraphs = [
        ...
        'I have now completed my A-levels in Mathematics, Further Mathematics, and Computer Science, and I am beginning my first year studying Computer Science at UCL. That transition feels like a natural next step: more depth, more independence, and more room to build things that stretch both my technical and creative instincts.',
