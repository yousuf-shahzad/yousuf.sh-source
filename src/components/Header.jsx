        ...
        <div className="p-10">
            <header className="fixed top-0 left-0 right-0 z-50 p-4 flex justify-between items-center brand-bg/90">
                ...
                <div className="relative z-40 flex w-full justify-between items-center">
                    <button
                        className={`text-xl sm:text-2xl brand-text header-title tracking-3 -skew-x-3 hover:-skew-x-12 transition ease-in-out duration-200 ${isMenuOpen ? 'sm:opacity-100 opacity-0' : 'opacity-100'}`}
                        onClick={() => navigate('/')}
                    >
                        Y.SH
                    </button>
                    ...
                    <ul className="space-y-6 xs:space-y-8 sm:space-y-10 md:space-y-12">
                        {[
                            ...
                            <li key={item.number} className="flex justify-between items-center group">
                                <p className="text-2xl xs:text-3xl sm:text-4xl md:text-4xl font-medium opacity-50 group-hover:brand-text group-hover:opacity-100 transition-all duration-300">
                                    /{item.number}
                                </p>
                                <button
